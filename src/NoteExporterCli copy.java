        ...
        while (true) {
            ...
            switch (input) {
                ...
                case "2":
                    ...
                    //         break;
                    // }
                    String[] types = {"plaintext","json","csv","markdown"};
                    String selectedType = types[Integer.parseInt(format) - 1];
                    ExportStrategy strategy = ExportStrategyFactory.getExportStrategy(selectedType);
                    ExportStrategyFactory.register("html", HtmlExport::new);
